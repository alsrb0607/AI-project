    ...
    if request.method == "POST":
        ...
        with torch.no_grad():
            if args.update:  # update all models (to fix SourceChangeWarning)
                for args.weights in ['yolov5s.pt']:
                    message = detect()
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        diagnosis = ['cd1', 'cd2', 'cd3', 'cd4', 'cd5', 'cd6', 'cd7', 'cd8', 'cd9', 'cd10', 'cd11', 'cd12', 'cd13', 'cd14']
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Flask app exposing yolov5 + x-ray models")
